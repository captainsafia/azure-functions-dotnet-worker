...
namespace Microsoft.Azure.Functions.SdkGeneratorTests
{
    public partial class FunctionMetadataProviderGeneratorTests
    {
        public class HttpTriggerTests
        {
            ...
            [Theory]
            [InlineData(LanguageVersion.Latest)]
            public async Task GenerateSimpleMinimalApiMetadataTest(LanguageVersion languageVersion)
            {
                string inputCode = """
                using System;
                using System.Collections.Generic;
                ...
                string expectedGeneratedFileName = $"MapActionGeneratedFunctionMetadataProvider.g.cs";
                string expectedOutput = """
                // <auto-generated/>
                using System;
                using System.Collections.Generic;
                ...
                await TestHelpers.RunTestAsync<MapActionFunctionMetadataProviderGenerator>(
                    _referencedExtensionAssemblies,
                    inputCode,
                    expectedGeneratedFileName,
                    expectedOutput,
